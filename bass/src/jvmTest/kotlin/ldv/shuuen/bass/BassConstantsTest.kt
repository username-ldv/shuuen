...
class BassConstantsTest {
  ...
  fun constantsMatchBundledJavaBindings() {
    ...
    assertMatches(midi, "BASS_ATTRIB_MIDI_SRC", Bass.BASS_ATTRIB_MIDI_SRC)
    ...
    assertMatches(midi, "MIDI_EVENT_CUTOFF", Bass.MIDI_EVENT_CUTOFF)
    assertMatches(midi, "MIDI_EVENT_FINETUNE", Bass.MIDI_EVENT_FINETUNE)
    assertMatches(midi, "MIDI_EVENT_PITCH", Bass.MIDI_EVENT_PITCH)
    assertMatches(midi, "MIDI_EVENT_PITCHRANGE", Bass.MIDI_EVENT_PITCHRANGE)
    ...
    assertMatches(midi, "MIDI_EVENT_TRANSPOSE", Bass.MIDI_EVENT_TRANSPOSE)
